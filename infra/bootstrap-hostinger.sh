...
log ""
log "Próximos pasos:"
log "  1. DNS: apuntar A records de mipiacetpv.tech / admin.mipiacetpv.tech / api.mipiacetpv.tech al IP de este VPS."
...
log "  4. Loguearse en https://admin.mipiacetpv.tech/superadmin y dar de alta el primer tenant (Thalia)."
