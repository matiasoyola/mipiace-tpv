...
**Rama:** rama de trabajo del módulo Reservas, integrada en `master` el 2026-08-19 (sesión catálogo extendido). Prompt: `docs/code-prompts/bloque-reservas-2-catalogo.md`.
