...
// v1.12 · base de integración: el formateador único vive en `lib/money.ts`
// desde v1.10.3. Aquí sólo se reexporta para no romper los imports de las
// pantallas de cierre de día (v1.11).
